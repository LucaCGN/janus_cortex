...
## Purpose
Reference docs explain what the system is for, what is already true, and which constraints should remain stable across planning waves.

Use reference docs for:
- product intent
- stable research hypotheses
- current validated system state
- durable schema, API, and analysis contracts

Use planning docs for:
- branch sequencing
- active execution packets
- subphase checklists
- dependency ordering and merge strategy
...
- [analysis_sampling_benchmarking_reference.md](/C:/Users/lnoni/OneDrive/Documentos/Code-Projects/janus_cortex/app/docs/reference/analysis_sampling_benchmarking_reference.md)
...
- [analysis_studio_frontend_reference.md](/C:/Users/lnoni/OneDrive/Documentos/Code-Projects/janus_cortex/app/docs/reference/analysis_studio_frontend_reference.md) - superseded historical frontend reference
...
- [app/docs/nba_analysis_player_impact_shadow_plan.md](/C:/Users/lnoni/OneDrive/Documentos/Code-Projects/janus_cortex/app/docs/nba_analysis_player_impact_shadow_plan.md)

### Platform And Contract Reference
...
- [app/docs/source_temporal_coverage.md](/C:/Users/lnoni/OneDrive/Documentos/Code-Projects/janus_cortex/app/docs/source_temporal_coverage.md)
- [app/docs/app_structure_modularization_plan.md](/C:/Users/lnoni/OneDrive/Documentos/Code-Projects/janus_cortex/app/docs/app_structure_modularization_plan.md)

### Workspace And Execution Conventions
- [app/docs/development_guide.md](/C:/Users/lnoni/OneDrive/Documentos/Code-Projects/janus_cortex/app/docs/development_guide.md)
- [app/docs/local_workspace_convention.md](/C:/Users/lnoni/OneDrive/Documentos/Code-Projects/janus_cortex/app/docs/local_workspace_convention.md)

### Historical Execution Context
- [app/docs/planning/archive/README.md](/C:/Users/lnoni/OneDrive/Documentos/Code-Projects/janus_cortex/app/docs/planning/archive/README.md)

## Update Rule
- If the document answers "what is this system and what is currently true?", it belongs in reference.
- If the document answers "what branch do we run next and how do we break it down?", it belongs in planning.
