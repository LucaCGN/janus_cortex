...
- data safety and validation hardening
- analysis strategy research and experiment design
- consumer adapters and frontend preparation
- season-continuity preparation for playoffs, preseason, and WNBA

## Current Planning Order
1. establish safe local and dev-database validation workflow
2. validate the current offline analysis stack end to end on a non-live database
3. build strategy-evaluation and sampling infrastructure
4. expose stable read-only consumer surfaces
5. build the dedicated frontend module
