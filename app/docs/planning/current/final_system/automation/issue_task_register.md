...
| JIT-70-05 | #70 | ready | janus-master-dev / postgame-review | Build fixture replay/backtest coverage for the four `postgame_replay_config_review_v1` cases, including fillability, score-gap, target-fill costs, duplicate-intent cooldown, and final-score outcome accounting. | Next executable code/test slice; no live-worker, live-money, or order path is required. |
