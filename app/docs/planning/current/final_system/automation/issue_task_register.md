...
| Task id | Issue | Status | Owner lane | Next executable step | Evidence / blocker |
|---|---:|---|---|---|---|
| JIT-55-01 | #55 | ready | nba-pregame-research / postgame-review | Feed #70 postgame evidence into entry-timing research for pregame, immediate-live, post-Q1, and stability-confirmed policies. | Updated #70 fixture artifact `postgame_replay_fixture_backtest_20260525T055152Z.json` provides the next rows: WNBA Atlanta/Dallas/Seattle low-band positive candidates and OKC/SAS Thunder Q4 subpenny negative bucket. Supports #61 but does not own live execution. |
