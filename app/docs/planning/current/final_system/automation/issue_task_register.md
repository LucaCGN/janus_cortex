...
| JIT-55-02 | #55 | ready | nba-pregame-research / basketball-intelligence | Backfill side-by-side replay windows for pregame resting, first live, post-Q1, and post-Q1-stability policies with cancellation/expiry and missed-entry accounting. | JIT-55-01 established the matrix shell and current rows; acceptance still needs broader side-by-side return/fill/missed-entry/adverse-selection comparison before StrategyPlan template changes. |
