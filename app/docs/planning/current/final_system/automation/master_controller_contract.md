...
After a covered NBA/WNBA game reaches final or settlement, unresolved event-scoped direct CLOB orders, positions, fills, or valuation mismatches are live-readiness blockers for the next event. They must route to a settlement/reconciliation issue before any new worker enablement or new live-order test. The 2026-05-18 Spurs/Thunder residual Thunder order/position is owned by [#57](https://github.com/LucaCGN/janus_cortex/issues/57). Closed [#50](https://github.com/LucaCGN/janus_cortex/issues/50) is the WNBA passive/shadow baseline report; active WNBA sustained capture and audit integration belongs to [#60](https://github.com/LucaCGN/janus_cortex/issues/60).
...
After [#57](https://github.com/LucaCGN/janus_cortex/issues/57) and [#58](https://github.com/LucaCGN/janus_cortex/issues/58) are closed, the controller must not continue treating either issue as the active development route or wait for new Spurs/Thunder settlement evidence before doing useful work. In a no-live/no-pregame window with a clean worktree and clear locks, the expected route is an open sprint issue with a bounded slice: [#59](https://github.com/LucaCGN/janus_cortex/issues/59) for portfolio-manager real-call reconciliation proof, [#60](https://github.com/LucaCGN/janus_cortex/issues/60) for WNBA active-window capture/readiness evidence, [#55](https://github.com/LucaCGN/janus_cortex/issues/55) for entry-timing/event-start expiry research, or [#56](https://github.com/LucaCGN/janus_cortex/issues/56) for active portfolio-manager action planning, frontend/profile discovery enforcement, one-shot portfolio order routing, cross-league basketball scanning, and gated grid/scalping service spawn work. If it cannot claim or work the selected issue, it must record the concrete blocker once.
