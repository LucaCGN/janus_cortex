...
After [#57](https://github.com/LucaCGN/janus_cortex/issues/57) and [#58](https://github.com/LucaCGN/janus_cortex/issues/58) are closed, the controller must not continue treating either issue as the active development route or wait for new Spurs/Thunder settlement evidence before doing useful work. In a no-live/no-pregame window with a clean worktree and clear locks, the expected route is an open sprint issue with a bounded slice: [#59](https://github.com/LucaCGN/janus_cortex/issues/59) for portfolio-manager real-call reconciliation proof, [#50](https://github.com/LucaCGN/janus_cortex/issues/50) for WNBA active-window capture/readiness evidence, [#55](https://github.com/LucaCGN/janus_cortex/issues/55) for entry-timing/event-start expiry research, or [#56](https://github.com/LucaCGN/janus_cortex/issues/56) for approved preview-first grid/cross-league scanner work. If it cannot claim or work the selected issue, it must record the concrete blocker once.
