...
After [#57](https://github.com/LucaCGN/janus_cortex/issues/57), [#58](https://github.com/LucaCGN/janus_cortex/issues/58), and [#60](https://github.com/LucaCGN/janus_cortex/issues/60) are closed, the controller must not continue treating those issues as the active development route or wait for stale settlement/WNBA evidence before doing useful work. Next-game sports readiness routes are [#61](https://github.com/LucaCGN/janus_cortex/issues/61) for the next NBA playoff minimum-size Janus live trade and [#62](https://github.com/LucaCGN/janus_cortex/issues/62) for WNBA promotion from shadow capture to controlled minimum-size live readiness. In a no-live/no-pregame window with #61/#62 freshly checkpointed or explicitly blocked, the expected route is an open sprint issue with a bounded slice such as [#55](https://github.com/LucaCGN/janus_cortex/issues/55) for entry-timing/event-start expiry research, a #63 child issue, or a new focused global-portfolio follow-up if the portfolio manager exposes fresh drift after closed foundations #56/#59. If it cannot claim or work the selected issue, it must record the concrete blocker once.
