...
| `janus-portfolio-manager` | cron | 6h deep pass | active | closed #56/#59 foundations; active portfolio follow-ups | Active Codex global portfolio manager for non-Janus-covered portfolio slots. May trade only through approved portfolio-manager order gates. |
