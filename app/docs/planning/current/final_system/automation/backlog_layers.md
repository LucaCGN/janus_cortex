...
| [#50](https://github.com/LucaCGN/janus_cortex/issues/50) | P1 | Blocked/report published | WNBA passive/shadow only. Blocker report `local/shared/reports/daily-live-validation/wnba_issue50_blocker_report_2026-05-19.md` shows the issue stalled because NBA live/settlement comments spilled into #50 and WNBA still lacks sustained active-window CLOB/trade capture plus 40-game calibration. |
