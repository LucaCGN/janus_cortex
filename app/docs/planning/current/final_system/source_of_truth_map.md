...
| Postgame evidence/LLM/blocker recovery | [#83](https://github.com/LucaCGN/janus_cortex/issues/83) | Recover May 27 WNBA postgame evidence, add model-usage accounting, and classify blockers as protective/harmful/evidence-gap for automation. | Read-only evaluation and issue/docs/task routing; no trading. |
...
| [#82](https://github.com/LucaCGN/janus_cortex/issues/82) | P0 | open | Reduce/stop lifecycle evidence implemented; requires live-window validation that stop/reduce candidates outrank rebuys without blocking unrelated sleeves. |
| [#83](https://github.com/LucaCGN/janus_cortex/issues/83) | P0 | open | WNBA postgame evidence and LLM/blocker review artifacts now exist; account-confirmed PnL remains blocked by the account-scoped order-lifecycle reconciliation timeout. |
...
| [#81](https://github.com/LucaCGN/janus_cortex/issues/81) | P1 | open | Cheap nano PBP dispatcher path implemented as non-executable sleeve context with deterministic fallback, escalation readback, and call-budget/cost-estimate evidence. |
