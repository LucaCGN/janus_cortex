...
| `janus-master-dev` | 15 minutes | Recurring Janus development/live-readiness executor for issue-backed work, especially #61/#62 sports readiness, #55 research support, #63-#70 live-runtime children, and new focused portfolio follow-ups when sports does not preempt them. | Not the global portfolio trader; no raw exchange bypass; Janus live actions only through approved Janus gates. |
...
| Portfolio lifecycle reconciliation | [#76](https://github.com/LucaCGN/janus_cortex/issues/76) | Reconcile the Maduro filled-position target gap and Colorado Avalanche target-fill/close evidence from fresh direct CLOB truth. | Portfolio-manager only through approved order paths and gates; no Janus NBA/WNBA authority. |
...
| [#64](https://github.com/LucaCGN/janus_cortex/issues/64), [#70](https://github.com/LucaCGN/janus_cortex/issues/70) | P0/P1 | open | Remaining #63 child work for normalized live snapshots/feed parity and postgame signal-performance review. |
| [#65](https://github.com/LucaCGN/janus_cortex/issues/65) | P0 | closed | Live signal schema and artifact persistence implemented in `ddbf6e0`; future changes should route through focused follow-up tasks under #63/#70. |
...
| [#67](https://github.com/LucaCGN/janus_cortex/issues/67) | P0 | closed | Event budget and sleeve transition helper implemented in `57da4ce`; future budget policy calibration belongs to #44/#70/#71 or a focused child issue. |
...
| [#71](https://github.com/LucaCGN/janus_cortex/issues/71) | P1 | closed | Project-chief performance review contract, deterministic artifact generator, and first daily review artifact implemented; future improvements route through #70/#55/#69 recommendations or focused follow-up tasks. |
...
| [#76](https://github.com/LucaCGN/janus_cortex/issues/76) | P0 | open | Reconcile Maduro filled-position target coverage and Colorado Avalanche target-fill/close evidence through the portfolio-manager path. |
