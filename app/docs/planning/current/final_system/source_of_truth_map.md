...
| [#82](https://github.com/LucaCGN/janus_cortex/issues/82) | P0 | open | Reduce/stop lifecycle, Q4/endgame loss mode, adverse-thesis rebuy suppression, stale/final cleanup, and local blocker enforcement. |
| [#83](https://github.com/LucaCGN/janus_cortex/issues/83) | P0 | open | WNBA postgame evidence recovery, LLM usage analysis, blocker efficacy review, and direct account-trade backfill routing. |
