...
- [app/docs/nba_analysis_parallel_workstreams.md](/C:/Users/lnoni/OneDrive/Documentos/Code-Projects/janus_cortex/app/docs/nba_analysis_parallel_workstreams.md)
  ...
  - now treated as completed-wave context rather than the active branch plan

## Archive Rule
- when a current planning doc stops guiding active work, do not delete it
- instead, either move it into this archive catalog or add a note here that points to it as historical rationale
- keep archived planning readable enough to answer "why was it done this way?" without reopening old branches
