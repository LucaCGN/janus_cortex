...
## Purpose
Keep the completed branch plans that shaped `main` available as historical rationale.

These branch plans are no longer active launch targets. They were merged and then moved here so future sessions can still understand the dependency order and the original scope boundaries.

## Archived Branch Catalog
- [data_dev_db_safety.md](/C:/Users/lnoni/OneDrive/Documentos/Code-Projects/janus_cortex/app/docs/planning/archive/branches/data_dev_db_safety.md)
...
- [frontend_analysis_comparison.md](/C:/Users/lnoni/OneDrive/Documentos/Code-Projects/janus_cortex/app/docs/planning/archive/branches/frontend_analysis_comparison.md)

## Archive Notes
- the safety and validation branches established the non-live execution discipline
- the strategy and benchmarking branches established the reusable multi-family experiment substrate
- the consumer and frontend branches exposed stable read-only analysis views
- the comparison branch moved the permanent studio from snapshot-only visibility to family-level comparison detail
