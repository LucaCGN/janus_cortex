...
DEFAULT_COMEBACK_REVERSION_V2_OPEN_CAP = 0.45
DEFAULT_COMEBACK_REVERSION_V2_ENTRY_PRICE_MIN = 0.15
DEFAULT_COMEBACK_REVERSION_V2_ENTRY_PRICE_MAX = 0.35
DEFAULT_COMEBACK_REVERSION_V2_MIN_MOMENTUM = 4.0
DEFAULT_COMEBACK_REVERSION_V2_MIN_SCORE_DIFF = -14.0
DEFAULT_COMEBACK_REVERSION_V2_MAX_SCORE_DIFF = -5.0
DEFAULT_COMEBACK_REVERSION_V2_TARGET_PRICE = 0.42
DEFAULT_COMEBACK_REVERSION_V2_TARGET_MOVE = 0.08
DEFAULT_COMEBACK_REVERSION_V2_STOP_LOSS = 0.05
DEFAULT_FAVORITE_PANIC_OPEN_MIN = 0.65
DEFAULT_FAVORITE_PANIC_SEEN_BELOW_PRICE = 0.50
DEFAULT_FAVORITE_PANIC_RECROSS_THRESHOLD = 0.52
DEFAULT_FAVORITE_PANIC_ENTRY_PRICE_MAX = 0.62
DEFAULT_FAVORITE_PANIC_MIN_MOMENTUM = 2.0
DEFAULT_FAVORITE_PANIC_MIN_SCORE_DIFF = -4.0
DEFAULT_FAVORITE_PANIC_TARGET_PRICE = 0.62
DEFAULT_FAVORITE_PANIC_TARGET_MOVE = 0.08
DEFAULT_FAVORITE_PANIC_STOP_LOSS = 0.05
DEFAULT_HALFTIME_Q3_REPRICING_OPEN_MIN = 0.35
DEFAULT_HALFTIME_Q3_REPRICING_OPEN_MAX = 0.75
DEFAULT_HALFTIME_Q3_REPRICING_ENTRY_MOVE = 0.05
DEFAULT_HALFTIME_Q3_REPRICING_MIN_PRICE = 0.55
DEFAULT_HALFTIME_Q3_REPRICING_MIN_MOMENTUM = 2.0
DEFAULT_HALFTIME_Q3_REPRICING_MIN_SCORE_DIFF = 1.0
DEFAULT_HALFTIME_Q3_REPRICING_TARGET_MOVE = 0.07
DEFAULT_HALFTIME_Q3_REPRICING_STOP_LOSS = 0.04
DEFAULT_HALFTIME_Q3_REPRICING_MAX_SECONDS_LEFT = 1440.0
DEFAULT_HALFTIME_Q3_REPRICING_MIN_SECONDS_LEFT = 1140.0
BACKTEST_BENCHMARK_CONTRACT_VERSION = "v11"
...
DEFAULT_BACKTEST_PORTFOLIO_POSITION_SIZE_FRACTION = 0.20
...
DEFAULT_BACKTEST_PORTFOLIO_MAX_CONCURRENT_POSITIONS = 5
DEFAULT_BACKTEST_PORTFOLIO_CONCURRENCY_MODE = "shared_cash_equal_split"
DEFAULT_BACKTEST_PORTFOLIO_SIZING_MODE = "static"
DEFAULT_BACKTEST_PORTFOLIO_TARGET_EXPOSURE_FRACTION = 0.80
DEFAULT_BACKTEST_PORTFOLIO_RANDOM_SLIPPAGE_MAX_CENTS = 20
DEFAULT_BACKTEST_PORTFOLIO_RANDOM_SLIPPAGE_SEED = 20260422
DEFAULT_BACKTEST_LLM_MODEL = "gpt-5.4-mini"
...
class BacktestRunRequest:
    ...
    portfolio_sizing_mode: str = DEFAULT_BACKTEST_PORTFOLIO_SIZING_MODE
    portfolio_target_exposure_fraction: float = DEFAULT_BACKTEST_PORTFOLIO_TARGET_EXPOSURE_FRACTION
    portfolio_random_slippage_max_cents: int = DEFAULT_BACKTEST_PORTFOLIO_RANDOM_SLIPPAGE_MAX_CENTS
    portfolio_random_slippage_seed: int = DEFAULT_BACKTEST_PORTFOLIO_RANDOM_SLIPPAGE_SEED
    llm_enable: bool = False
    llm_model: str = DEFAULT_BACKTEST_LLM_MODEL
    llm_compare_models: tuple[str, ...] = ()
    llm_iteration_games: int = DEFAULT_BACKTEST_LLM_ITERATION_GAMES
    llm_iteration_count: int = DEFAULT_BACKTEST_LLM_ITERATION_COUNT
