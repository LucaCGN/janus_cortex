...
def build_live_strategy_tick_kwargs(args: Namespace) -> dict[str, Any]:
    ...
    if args.max_order_buy_notional_usd is not None:
        kwargs["max_order_buy_notional_usd"] = args.max_order_buy_notional_usd
    if args.event_cap_usd is not None:
        kwargs["event_cap_usd"] = args.event_cap_usd
    if args.side_budget_mode:
        kwargs["side_budget_mode"] = args.side_budget_mode
    if args.max_same_side_exposure_pct is not None:
        kwargs["max_same_side_exposure_pct"] = args.max_same_side_exposure_pct
    return kwargs
