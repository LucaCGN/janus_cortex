...
def evaluate_minimum_order_policy(
    ...
    *,
    ...
    valid_order_type = order_type in {"limit", "market"}
    share_minimum_applies = order_type == "limit"
    notional_minimum_applies = order_type == "market"
    order_type_minimum_rule = {
        "limit": "limit_min_shares",
        "market": "market_min_notional",
    }.get(order_type, "unknown_order_type")
    ...
    elif share_minimum_applies and size < min_size:
        blockers.append("minimum_limit_order_size_not_met")
        blockers.append("minimum_order_size_not_met")
    if notional_minimum_applies and (notional is None or notional < min_buy_notional_usd):
    ...
    return PolymarketSafetyCheck(
        ...
        blockers=blockers,
        evidence={
            "policy_schema_version": MINIMUM_ORDER_POLICY_SCHEMA_VERSION,
            "side": side,
            ...
            "order_type_minimum_rule": order_type_minimum_rule,
            "minimum_rule_status": "passed" if not blockers else "blocked",
            "minimum_rule_blockers": list(blockers),
...
__all__ = [
    ...
    "MINIMUM_ORDER_POLICY_SCHEMA_VERSION",
    "NON_AUTHORITATIVE_TRUTH_SOURCES",
