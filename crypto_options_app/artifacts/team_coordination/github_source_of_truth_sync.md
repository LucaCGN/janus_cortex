...
- Runtime DB adapter audit: 0 production runtime direct SQLite blockers, 13 review-required SQLite usages, tracked under issue [#152](https://github.com/LucaCGN/janus_cortex/issues/152).
