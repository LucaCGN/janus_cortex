...
def main() -> None:
    parser = add_cycle_args(base_parser("Record or trigger one Janus data-refresh cycle."))
    args = parser.parse_args()
    exit_for_response(api_json(args.api_root, "POST", "/v1/ops/data-refresh", cycle_payload(args)))
