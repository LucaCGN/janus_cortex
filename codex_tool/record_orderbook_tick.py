...
def main() -> None:
    parser = base_parser("Record one or more observed market orderbook ticks into Janus.")
    ...
    exit_for_response(api_json(args.api_root, "POST", "/v1/watchlists/orderbook-ticks", {"source": args.source, "ticks": ticks}))
