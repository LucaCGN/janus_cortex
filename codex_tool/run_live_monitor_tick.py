...
def main() -> None:
    parser = add_cycle_args(base_parser("Run one bounded live-monitor tick."))
    args = parser.parse_args()
    exit_for_response(api_json(args.api_root, "POST", "/v1/ops/live-monitor", cycle_payload(args)))
